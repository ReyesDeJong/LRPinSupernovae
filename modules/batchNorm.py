...
class BatchNorm(Module):
    ...
    def __init__(self, output_depth, phase_train, is_fullyConnected = False, batch_size = None, input_dim = None, input_depth=None,
                 name="batchNorm", param_dir=None):
...
#initialice random weights and biases
            ...
            if(self.is_fullyConnected):
                batch_mean, batch_var = tf.nn.moments(self.input_tensor, [0], name='moments')
            else:
